...
.btn-primary {
    ...
    <body>
       ...
       <form class="row g-3" action="Booking" method="post">
       <%
...
%>
  ...
  <div class="col-md-4">
	...
	List<Shuttle> shuttleList = shuttleService.readShuttleTimeAndDate(title);
	
	for (Shuttle i : shuttleList){
    	%>
      <option ><%= i.getDate() %></option>
      	<%
	}
    }
  ...
  <div class="col-md-4">
	...
	ShuttleService shuttleService  = new ShuttleService();
	List<Shuttle> shuttleList = shuttleService.readShuttleTimeAndDate(title2);
